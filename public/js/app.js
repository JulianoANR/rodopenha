...
/* harmony import */ var _components_selects_Select_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/selects/Select.js */ "./resources/js/components/selects/Select.js");
...
alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].data('select', _components_selects_Select_js__WEBPACK_IMPORTED_MODULE_4__["default"]);
...
/***/ "./resources/js/components/selects/Select.js":
/*!***************************************************!*\
  !*** ./resources/js/components/selects/Select.js ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./resources/js/components/selects/SelectUser.js":
/*!*******************************************************!*\
  !*** ./resources/js/components/selects/SelectUser.js ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  function dropdown_toggle(event) {
    ...
    var active = element.classList.contains('is-dropdown-show');
    /**
     * Hide sensible
     */
  ...
  function dropdown_sensible_close() {
    var dropdowns_sensible = document.querySelectorAll('[data-dropdown-sensible]');
    dropdowns_sensible.forEach(function (dropdown) {
      var element = dropdown.nextElementSibling;
      element.classList.remove('is-dropdown-show');
  ...
  function dropdown_outside(event) {
    ...
    var hasDropdown = target.closest('.is-dropdown-show') !== null;
  ...
  function collapse_toggle() {
    var element = this.nextElementSibling;
    var collapsed = element.classList.contains('is-collapsed');
  ...
  function collapse_close(element) {
    ...
    element.style.setProperty('--collapse-height', element.scrollHeight + "px");
    setTimeout(function () {
      return element.style.setProperty('--collapse-height', "0px");
    }, 5);
    setTimeout(function () {
  ...
  document.querySelectorAll('.waves-effect').forEach(function (element) {
    element.addEventListener('click', function (event) {
      var rect = this.getBoundingClientRect();
      var position_X = event.clientX - rect.left - 12;
      var position_Y = event.clientY - rect.top - 12;
  ...
  dropdownCollection.forEach(function (dropdown) {
    dropdown.addEventListener('click', dropdown_toggle);
  });
  collapseCollection.forEach(function (collapse) {
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/app"], () => (__webpack_require__("./resources/css/datatable.css")))
