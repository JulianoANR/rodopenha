    ...
    <div class="my-6 px-4 md:px-6">
        <div class="flex flex-wrap gap-2 justify-between items-center">
            <div class="w-full md:w-max">
                ...
                <x-breadcrumb :path="['Truck' => route('trucks.index')]" />
            </div>

            <a class="button button-primary uppercase hidden md:flex " href="{{ route('trucks.create') }}">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-left">
                                            <div class="inline-flex items-center gap-3">
                                                <button class="button button-icon button-icon-xs button-primary rounded">
